...
-- 8.	What is the total revenue generated from rentals for each actor in the database?
 ...
 select a.actor_id, a.first_name, a.last_name, sum(f.rental_rate* f.rental_duration) as Revenue
from actor a
...
-- 11.how many films in the comedy category have a rental rate higher than theaverage rental rate? 
